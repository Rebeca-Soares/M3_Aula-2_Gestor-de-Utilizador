...
const contadorSpan = document.getElementById('contador') as HTMLSpanElement;
const nomeInput = document.getElementById('name') as HTMLInputElement;
const emailInput = document.getElementById('email') as HTMLInputElement;
const addBnt = document.getElementById('addBnt') as HTMLButtonElement;
...
const userDetailsDiv = document.createElement('div') as HTMLDivElement;
userDetailsDiv.className = 'user-details';
userDetailsDiv.style.display = 'none';
document.body.appendChild(userDetailsDiv)

const filtersDiv = document.getElementById('filter') as HTMLDivElement;
...
function renderUsers(users: UserClass[] = UserList): void {
    listDiv.innerHTML = '';
...
//Exercício 7
function Userdisable(id: number): void {
...
searchInput.addEventListener('input', () => {
    ...
    const orderName = document.getElementById('orderName') as HTMLButtonElement;
...
function showUserDetails(user: UserClass):void {
